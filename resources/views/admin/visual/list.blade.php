            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <section id="customer-list">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5>Visual <span class="float-right"><a href="{{ route('create.visual') }}"
                                                ...
                                                <tbody>
                                                    @foreach ($users as $key => $user)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('show.visual', $user->id) }}"
                                                                    class="btn btn-success">View</a>
                                                                <a href="{{ route('edit.visual', $user->id) }}"
                                                                    class="btn btn-warning">Edit</a>
                                                                <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.visual', $user->id) }}
                                                                    data-title="Are you sure?"
                                                                    data-body="Mediate will be deleted!" data-icon="warning"
                                                                    data-success="Mediate successfully deleted!"
                                                                    data-cancel="Mediate is safe!" title="Delete">Delete</i>
                                                                </a>
                                                                ...
                                                                <div style="position: relative;" data-table=""
                                                                    ...
                                                                    data-url="{{ route('status.visual', ['id' => $user->id, 'status' => $user->active]) }}"
