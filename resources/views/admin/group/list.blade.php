...
<body class="bg-theme bg-theme1">
    <div id="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!--Start Custromer Contentp-->
                <section id="customer-list">
                    <div class="row mb-2">
                      <div class="col-md-12">
                        <h5>Groups <span class="float-right"><a href="{{route('create.group')}}" class="btn btn-primary">Create</a></span></h5>
                      </div>
                    </div>
                                  ...
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <a href="{{route('edit.group',$user->id)}}" class="btn btn-warning">Edit</a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
