        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                  <hr>
                  <form id="edit-mediate_tags" action="{{route('update.group')}}" method="post">
                  @isset($mediate_tag)
                  ...
                  @endisset
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" value="{{$mediate_tag->group_name??""}}" name="group_name">
                                <span class="error group_name-error">{{ $errors->first('group_name') }}</span>
                            </div>
