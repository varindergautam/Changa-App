        ...
        <div class="content-wrapper">
            ...
            <!--Start Custromer Content-->
                <section id="customer-list">
                    <div class="row mb-2">
                      <div class="col-md-12">
                        <h5>Tags <span class="float-right"><a href="{{route('create.therapy_tags')}}" class="btn btn-primary">Create</a></span></h5>
                      </div>
                    </div>
                                  ...
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>{{$user->tag}}</td>
                                        <td>
                                            <a href="{{route('edit.therapy_tags',$user->id)}}" class="btn btn-warning">Edit</a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
