        ...
        <div class="content-wrapper">
            ...
            <!--Start Custromer Content-->
                <section id="customer-list">
                  <div class="row mb-2">
                    <div class="col-md-12">
                      <h5>Listen <span class="float-right"><a href="{{route('create.listens')}}" class="btn btn-primary">Create</a></span></h5>
                    </div>
                  </div>
                                  ...
                                  <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <a href="{{route('show.listens', $user->id)}}" class="btn btn-success">View</a>
                                            <a href="{{route('edit.listens',$user->id)}}" class="btn btn-warning">Edit</a>
                                            <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.listens', $user->id) }}
                                                                    data-title="Are you sure?"
                                                                    data-body="Listen will be deleted!"
                                                                    data-icon="warning"
                                                                    data-success="Listen successfully deleted!"
                                                                    data-cancel="Learn is safe!"
                                                                ...
                                                                <div style="position: relative;" data-table=""
                                                                    ...
                                                                    data-url="{{ route('status.listens', ['id' => $user->id, 'status' => $user->active]) }}"
