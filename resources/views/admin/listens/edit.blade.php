                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <hr>
                                    <form id="edit-user" action="{{ route('update.listens') }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 form-group">
                                                <label for="input-2">Learn Tag</label>
                                                <select class="form-control" name="tag[]" multiple="mutliple" id="tags">
                                                    @if ($tags->count() > 0)
                                                        @foreach ($tags as $mediator_category)
                                                            <option value="{{ $mediator_category->id }}"
                                                                {{!empty($multi) > 0 && in_array($mediator_category->id, $multi) ? 'selected' : '' }}>
                                                                {{ $mediator_category->tag }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                                <span class="error tag-error">{{ $errors->first('tag') }}</span>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 form-group">
                                                ...
                                                @isset($user)
                                                    <input type="hidden" value="{{ $user->file_type ?? '' }}"
                                                        name="file_type">
                                            ...
                                            <div class="col-md-12 col-sm-12 form-group">
                                                ...
                                                <input type="hidden" value="{{ @$user->background_image }}"
                                                    name="background_image_hiden">
                                                ...
                                                @if (@$user->background_image)
                                                    <img alt="image" class="mb-2"
                                                        src='{{ asset('/storage/file/' . $user->background_image) }}'
                                                        width="100px" />
                                                @endif
                                            </div>
