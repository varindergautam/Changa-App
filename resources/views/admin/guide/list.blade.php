            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <section id="customer-list">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5>Guides <span class="float-right"><a href="{{ route('create.guide') }}"
                                                ...
                                                <tbody>
                                                    @foreach ($users as $key => $user)
                                                        <tr>
                                                            ...
                                                            <td>{{ $user->guideCategory->title }}</td>
                                                            <td>{{ $user->title }}</td>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('show.guide', $user->id) }}"
                                                                    class="btn btn-success">View</a>
                                                                <a href="{{ route('edit.guide', $user->id) }}"
                                                                    class="btn btn-warning">Edit</a>
                                                                <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.guide', $user->id) }}
                                                                    data-title="Are you sure?"
                                                                    data-body="guide will be deleted!" data-icon="warning"
                                                                    data-success="guide successfully deleted!"
                                                                ...
                                                                <div style="position: relative;" data-table=""
                                                                    ...
                                                                    data-url="{{ route('status.guide', ['id' => $user->id, 'status' => $user->active]) }}"
