            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <section id="customer-list">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5>Category <span class="float-right"><a href="{{ route('create.guide_category') }}"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($users as $key => $user)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('show.guide_category', $user->id) }}"
                                                                    class="btn btn-success">View</a>
                                                                <a href="{{ route('edit.guide_category', $user->id) }}"
                                                                    class="btn btn-warning">Edit</a>
                                                                {{-- <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.guide_category', $user->id) }}
                                                                    data-title="Are you sure?"
                                                                    data-body="Category will be deleted!"
                                                                    data-icon="warning"
