        ...
        <div class="content-wrapper">
            ...
            <!--Start Custromer Content-->
                <section id="customer-list">
                  <div class="row mb-2">
                    <div class="col-md-12">
                      <h5>Mediates <span class="float-right"><a href="{{route('create.mediates')}}" class="btn btn-primary">Create</a></span></h5>
                    </div>
                  </div>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <img alt="image" class="mb-2" src='{{asset('/storage/file/'. $user->file)}}' width="100px"/>
                                          @endif  
                                        </td>
                                        <td>
                                            <a href="{{route('show.mediates', $user->id)}}" class="btn btn-success">View</a>
                                            <a href="{{route('edit.mediates',$user->id)}}" class="btn btn-warning">Edit</a>
                                            <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.mediates', $user->id) }}
                                                                    data-title="Are you sure?"
                                                                    data-body="Mediate will be deleted!"
                                                                    data-icon="warning"
                                                                    data-success="Mediate successfully deleted!"
                                                                    data-cancel="Mediate is safe!"
                                                                ...
                                                                <div style="position: relative;" data-table=""
                                                                    ...
                                                                    data-url="{{ route('status.mediates', ['id' => $user->id, 'status' => $user->active]) }}"
