            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <section id="customer-list">
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5>Audio <span class="float-right"><a href="{{ route('create.audio') }}" class="btn btn-primary">Create</a></span></h5>
                            </div>
                        </div>
                                                ...
                                                <tbody>
                                                    @foreach ($users as $key => $user)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ route('show.audio', $user->id) }}"
                                                                    class="btn btn-success">View</a>
                                                                <a href="{{ route('edit.audio', $user->id) }}"
                                                                    class="btn btn-warning">Edit</a>
                                                                <a class="delete-data btn btn-danger"
                                                                    href="javascript:void(0);"
                                                                    data-url={{ route('delete.audio', $user->id) }}
                                                                ...
                                                                <div style="position: relative;" data-table=""
                                                                    ...
                                                                    data-url="{{ route('status.audio', ['id' => $user->id, 'status' => $user->active]) }}"
